...
$view_list = $Ticketing->get_kra();
$Ticketing->add_kra($_POST);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="container-fluid">
                    <!-- Content Row -->
                    <h1 class="h3 mb-0 text-gray-800">Key Response Area (KRA)</h1><br><hr>
                    <!-- ./Content Row -->
                <!-- card here --->
            <div class="row">
        <div class="col-sm-4">
...
<div class="col-lg-10">
    <div class="card mb-4">
        <div class="card-header"><h6 class="m-0 font-weight-bold text-primary">Create KRA</h6></div>
            <div class="card-body">
                <form enctype="multipart/form-data" method="post">
                <input type="text" name="kra" id="kra" class="form-control form-control-mb-2" placeholder="KRA" required>
                <p></p>
                <button type="submit" id="add_kra" name="add_kra" class="btn btn-primary">Submit</button>
                </form>
...
<!-- ./create form -->
    ...
    <div class="col-sm-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
            <div class="card mb-4">
            <div class="card-header"><h6 class="m-0 font-weight-bold text-primary">KRA List</h6></div>
    ...
    <?php foreach($view_list as $view){?>
      <tr>
        <td><a href="#" onclick="openModal(<?= $view['kra_id']; ?>); return false;"><i class="fas fa-times"></i></a></td>
        <td><span class="text-gray-900 p-3 m-0"><strong><?= $view['kra_type'];?></strong></span></td>
      </tr>
    <?php } ?>
</tbody>
</table>
    ...
    <!-- display error --->
            <div class="container mt-5">
                <?php if (isset($_GET['record_exists']) && $_GET['record_exists'] == 1): ?>
                    ...
                    <i class="fa fa-exclamation" style="font-size:20px"></i> <strong>Denied!</strong> This KRA contains record. Deletion is not allowed.
                </div>
            <?php endif; ?>
        </div>
    <!--./display error -->
...
<!--./card here -->
    ...
    document.getElementById('modalYes').addEventListener('click', function() {
      ...
      if (kraId !== null) {
        window.location.href = './tools/delete-kra.php?id=' + kraId;
      }
      closeModal();
    });
</script>
<!-- ./modal js -->
    <script>
        ...
        setInterval(function(){
            ...
            window.location.replace("http://localhost/ticket/kra-list");
