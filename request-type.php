...
$view_list = $Ticketing->request_list();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="container-fluid">
                    <!-- Content Row -->
                    <h1 class="h3 mb-0 text-gray-800">Request</h1><br><hr>
                    <!-- ./Content Row -->
                <!-- card here --->
            <div class="row">
        <div class="col-sm-4">
...
<div class="col-lg-10">
    <div class="card mb-4">
        <div class="card-header"><h6 class="m-0 font-weight-bold text-primary">Type of request</h6></div>
            <div class="card-body">
                <form enctype="multipart/form-data" method="post">
                <p><input type="text" name="request" id="request" class="form-control form-control-mb-2" placeholder="Type Request" required>
                </p><input type="text" name="desc" id="desc" class="form-control form-control-mb-2" placeholder="description" required><p></p>
                <button type="submit" id="add_requesttype" name="add_requesttype" class="btn btn-primary">Submit</button>
                </form>
...
<!-- ./create form -->
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
            <div class="card mb-4">
            <div class="card-header"><h6 class="m-0 font-weight-bold text-primary">Request List</h6></div>
    ...
    <?php foreach($view_list as $view){?>
      <tr>
        <td><a href="#" onclick="openModal(<?= $view['request_id']; ?>); return false;"><i class="fas fa-times"></i></a></td>
        <td><span class="text-gray-900 p-3 m-0"><strong><?= $view['request_type'];?></strong></span></td>
        <td><span class="text-gray-900 p-3 m-0"><span class="justified"><?= $view['request_type_desc'];?></span></span></td>
      </tr>
    <?php } ?>
</tbody>
</table>
        ...
        <!-- display error --->
            <div class="container mt-5">
                <?php if (isset($_GET['record_exists']) && $_GET['record_exists'] == 1): ?>
                    ...
                    <i class="fa fa-exclamation" style="font-size:20px"></i> <strong>Denied!</strong> This Request Type contains record. Deletion is not allowed.
                </div>
            <?php endif; ?>
        </div>
    <!--./display error -->
...
<!-- ./modal js -->
    <script>
        ...
        setInterval(function(){
            ...
            window.location.replace("http://localhost/ticket/request-type");
