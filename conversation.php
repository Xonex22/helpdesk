...
<!--              <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="http://localhost/ticket/white_chat.html"></iframe>
            </div><hr> -->

           <!-- chat -->
                      <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="http://localhost/ticket/convo2.php"></iframe>
            </div>
           <!-- ./chat --> 
