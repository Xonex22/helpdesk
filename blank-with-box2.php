            ...
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="col-lg-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Details1</h6></div>
                        <!--- data --->
                        data here
                        <!-- ./data --></div>
                    </div><p>          
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Details2</h6></div>
                        <!--- data --->
                        data here
                        <!-- ./data --></div>
                    </div>          
                        ...
                        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Details3</h6></div>
                        <!--- data --->
                        data here
                        <!-- ./data -->
                        </div>
